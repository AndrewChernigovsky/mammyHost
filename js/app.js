...
var _inputMask = _interopRequireDefault(require("./components/inputMask"));
...
var windowWidthClient = window.clientWidth;
var SHAPE = document.getElementById('mainFormShape');
var active = 'active';
var menuBtn = document.querySelectorAll('.menuButton');
var popupCall = document.getElementById('popupCall__mainID');
var btnClosePopupCall = document.getElementById('popupCallBtnCloseID');
var tarifWrapper = document.querySelectorAll('.prices-section__tarif');
var NAV = document.querySelector('.js-burger');
var BURGER = document.querySelector('.burger');
var blockWrapperSteps = document.querySelector('.stepsWorking-section__wrapper1');
...
var getCall = document.querySelector(".PopupCall button[type='submit']");
var politeCheckbox = document.querySelector(".PopupCall input[type='checkbox']");
var titlesAnima = document.querySelectorAll('.titleIntro-anima .animaH2');
document.addEventListener('DOMContentLoaded', function () {
  menuBtn.forEach(function (e) {
    e.addEventListener('click', function () {
      btnClosePopupCall.addEventListener('click', function () {
        if (popupCall.classList.contains(active)) {
          ...
          BODY.style.width = "".concat(windowWidth) + 'px';
        } else {
          BURGER.classList.remove(active);
          BODY.style.overflow = 'auto';
          BODY.style.width = "".concat(windowWidth) + 'px';
  ...
  tarifWrapper.forEach(function (e) {
    e.addEventListener('click', function () {
...
var callbackContacts = function callbackContacts(entries, observer) {
...
var callbackSHAPE = function callbackSHAPE(entries, observer) {
  entries.forEach(function (entry) {
    if (entry.isIntersecting) {
      var ratio = entry.intersectionRatio;
      if (ratio < 0.9) {
        SHAPE.style.borderRadius = "\n            ".concat(100 - ratio * 100, "%\n            ").concat(100 - ratio * 100, "%\n            0 0");
      } else {
        ratio = 1;
        SHAPE.style.borderRadius = "\n            ".concat(100 - ratio * 100, "%\n            ").concat(100 - ratio * 100, "%\n            0 0");
      }
...
var observerSHAPE = new IntersectionObserver(callbackSHAPE, optionsSHAPE);
var observerContacts = new IntersectionObserver(callbackContacts, optionsContacts);
...
var variant = document.querySelector('.variantSection-wrapper .stepsWorking-section__wrapper');
var variant1 = document.querySelector('.variantSection-wrapper');
var introSectionWrapper = document.querySelector('.intro-section__wrapper');
if (variant) {
  var foo = function foo() {
    var el0 = variant.getBoundingClientRect();
    var el1 = introSectionWrapper.getBoundingClientRect();
    var x = el1.left + 'px';
    variant1.style.marginLeft = "".concat(x);
  };
  var el0 = variant.getBoundingClientRect();
  var el1 = introSectionWrapper.getBoundingClientRect();
...
var jsformButton = document.querySelector('.js-form button[type="submit"]');
var jsForm1 = document.querySelector('.js-form1');
var jsformButton1 = document.querySelector('.js-form1 button[type="submit"]');
var jsForm2 = document.querySelector('.js-form2');
var jsFormPopup = document.querySelector('.js-formPopup');
var jsformButton2 = document.querySelector('.js-form2 button[type="submit"]');
var phoneInput = document.querySelector('.js-form input[data-mask="tel"]');
var phoneInput1 = document.querySelector('.js-form1 input[data-mask="tel"]');
var phoneInput2 = document.querySelector('.js-form2 input[data-mask="tel"]');
var phoneInput3 = document.querySelector('.js-formPopup input[data-mask="tel"]');
var nameInput = document.querySelector('.js-form input[name="username"]');
var nameInput1 = document.querySelector('.js-form1 input[name="username"]');
var nameInput2 = document.querySelector('.js-form2 input[name="username"]');
var nameInput3 = document.querySelector('.js-formPopup input[name="username"]');
if (phoneInput) {
...
if (jsForm1) {
  jsForm1.addEventListener('submit', function (e) {
    var valuePhone = phoneInput1.value;
    var re = /^(\+7|7|8)?[\s\-]?\(?[489][0-9]{2}\)?[\s\-]?[0-9]{3}[\s\-]?[0-9]{2}[\s\-]?[0-9]{2}$/;
    var p = document.createElement('p');
    if (!valuePhone.match(re) === true) {
      e.preventDefault();
...
if (jsForm2) {
  jsForm2.addEventListener('submit', function (e) {
    var valuePhone = phoneInput2.value;
    var re = /^(\+7|7|8)?[\s\-]?\(?[489][0-9]{2}\)?[\s\-]?[0-9]{3}[\s\-]?[0-9]{2}[\s\-]?[0-9]{2}$/;
    var p = document.createElement('p');
    if (!valuePhone.match(re) === true) {
      e.preventDefault();
...
if (jsFormPopup) {
  jsFormPopup.addEventListener('submit', function (e) {
    var valuePhone = phoneInput3.value;
    var re = /^(\+7|7|8)?[\s\-]?\(?[489][0-9]{2}\)?[\s\-]?[0-9]{3}[\s\-]?[0-9]{2}[\s\-]?[0-9]{2}$/;
    var p = document.createElement('p');
    if (!valuePhone.match(re) === true) {
      e.preventDefault();
...
},{"./components/burger-menu":3,"./components/inputMask":4,"./components/scroll-smooth":5}],3:[function(require,module,exports){
"use strict";
...
var BURGERCLOSE = document.querySelector('#btnClose');
var BURGER = document.querySelector('.burger');
var NAV = document.querySelector('.js-burger');
...
},{"inputmask":1}],5:[function(require,module,exports){
"use strict";
